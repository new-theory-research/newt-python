...
_SAMPLE_MODELS = [
    ...
    {"uid": "base_modelafp3", "type": "base", "base": None, "tags": []},
]
...
def test_models_renders_axes_from_contract(monkeypatch):
    ...
    ft_line = next(l for l in lines if "ft_base_modelafp3" in l)
    base_line = next(l for l in lines if l.strip().startswith("base_modelafp3"))
