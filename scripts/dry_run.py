...
Usage:
    ...
    python scripts/dry_run.py wss://removed-endpoint.invalid/stream
...
def main() -> None:
    ...
    # ModelA-FP3 camera keys (matches serve_modela._CAMERA_KEYS).
    ...
    def mock_read_state() -> dict:
        ...
        # ModelA-FP3 observation: include depth + camera matrices so UnprojectPoints runs.
